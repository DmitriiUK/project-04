...
class Bike(models.Model):
    ...
    mainbody = models.CharField(max_length=300)
    ...
    frontwheelmaterial = models.CharField(max_length=30)
    rearwheelmaterial = models.CharField(max_length=30)
    fronttyre = models.CharField(max_length=30)
    reartyre = models.CharField(max_length=30)
